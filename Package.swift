...
let package = Package(
    ...
    dependencies: [
        .package(name: "KommunicateCore_iOS_SDK", url: "https://github.com/Sathyan-Elangovan/KommunicateCore-iOS-SDK.git", .revision("12e4f74f8e8d5fa62fc75371f65c6ec52e5e904b")),
