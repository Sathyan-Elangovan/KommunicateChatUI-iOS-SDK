...
let package = Package(
    ...
    dependencies: [
        .package(name: "KommunicateCore-iOS-SDK", url: "https://github.com/Sathyan-Elangovan/KommunicateCore-iOS-SDK.git",.revision("974b3cd363afd8cc5ce45085ecb63d5ae421df9b")),
